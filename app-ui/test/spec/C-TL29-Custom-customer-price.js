...
describe('cabinDetailsController for C-TL29-Custom customer price', function () {
    ...
    it('should be able to remove a price from the table', function () {
    	...
    	expect(scope.priceCategories[priceId-1].id).not.toEqual(priceId);
    });
    ...
    it('Check be able to add a price row into the pice matrix', function () {
    	...
    	expect(scope.priceCategories[newPriceId-1].id).toEqual(newPriceId);
